        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InnerUserId = table.Column<Guid>(type: "uuid", nullable: false),
                    InnerUserId1 = table.Column<string>(type: "text", nullable: true),
                    OrderId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_AspNetUsers_InnerUserId1",
                        column: x => x.InnerUserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DatePublishing = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookWishList", x => new { x.WishListsid, x.booksISBN });
                    table.ForeignKey(
                        name: "FK_BookWishList_Books_booksISBN",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookWishList_booksISBN",
                table: "BookWishList",
                column: "booksISBN");
