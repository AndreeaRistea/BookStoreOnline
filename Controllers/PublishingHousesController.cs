...
namespace Proiect_CE.Controllers
{
    public class PublishingHousesController : Controller
    {
        ...
        public PublishingHousesController(BookStoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.PublishingHouses != null ? 
                          ...
                          Problem("Entity set 'BookStoreContext.PublishingHouse'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BookStoreContext.PublishingHouse'  is null.");
            }
            var publishingHouse = await _context.PublishingHouses.FindAsync(id);
            if (publishingHouse != null)
            {
